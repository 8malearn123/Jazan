...
export function CtaStrip() {
  return (
    <section className="pb-16">
      <Container>
        <div className="flex flex-col items-start justify-between gap-6 rounded-[22px] border border-line bg-white p-8 shadow-[0_8px_28px_rgba(28,42,38,.06)] sm:flex-row sm:items-center sm:p-11">
          <div>
